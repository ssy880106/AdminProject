<?php include '../view/header.php'; ?>
    <main>
        ...
        <?php else: ?>
			...
			<br>* Enter a quantity of 0 to completely remove an item.
			<br>* Enter a new number under quantity to correct or make large quanity purchases.
            </p>
            </form>
        <?php endif; ?>
        <p><a href=".?action=show_add_item">Add Item</a></p>
        <p><a href=".?action=empty_cart">Empty Cart</a></p>
        <p><a href=".?action=end_session">End Session & Delete Cookie</a>&nbsp;&nbsp;<a href="../about">About Us</a>&nbsp;&nbsp;<a href="../products">Products</a>&nbsp;&nbsp;<a href="../admin">Administrator</a></p>
